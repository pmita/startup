...
export default async function CourseCard({
  ...
  <div className="full columnTopCenter gap-4 shadow-xl rounded-[12px]">
    <div className="full cardImageBox bg-primary-blue rounded-t-[12px]">
      ...
      <div className="detailsBox absolute columnCenterLeft gap-2 w-[90%] translate-x-[-0%] translate-y-[10%] transition-all duration-[0.3s] ease-[ease-in-out] overflow-hidden px-4 py-2 rounded-b-[12px] left-[5%] bottom-[10%] h-2/5 bg-primary-white p-4">
